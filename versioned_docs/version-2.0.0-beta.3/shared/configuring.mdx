...
- `extensionOptions` provides options for extensions:
  - `ocw`
    - `removeDashes` if set to true will remove dashes from OCW level codes for easier copying and pasting.
- `clear` allows you to set a default argument for the `!clear` command.
